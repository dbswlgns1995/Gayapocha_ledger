...
public class SnacksActivity extends AppCompatActivity {
    ...
    private String TAG = "***SnacksActivity";
    ...
    private String[] menu_title = {"수구레무침","수구레볶음","오삼불고기","오돌뼈","닭갈비","돼지석쇠","부추전"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        chart = findViewById(R.id.snack_piechart);

        bottom_text = findViewById(R.id.snack_text);

        date_btn = findViewById(R.id.snack_dmy_btn);
        date_btn.setValue(0);
        date_btn.setOnValueChangedListener(new ToggleButton.OnValueChangedListener() {
            ...
            public void onValueChanged(int value) {
                switch (value){
                    case 0:
                        DatePickerDialog dialogFragment = new DatePickerDialog(SnacksActivity.this, dateListener, tyear, tmonth - 1, tday);
                        dialogFragment.show();
                        break;
                    case 1:
                        final Calendar today = Calendar.getInstance();
                        MonthPickerDialog.Builder builder = new MonthPickerDialog.Builder(SnacksActivity.this, new MonthPickerDialog.OnDateSetListener() {
                            @Override
                        ...
                        break;
                    case 2:
                        MonthPickerDialog.Builder year_builder = new MonthPickerDialog.Builder(SnacksActivity.this, new MonthPickerDialog.OnDateSetListener() {
                            @Override
                            public void onDateSet(int selectedMonth, int selectedYear) {
                                // year 를 선택했을때
        ...
        mDrawerLayout = (DrawerLayout) findViewById(R.id.snack_drawer_layout);
        ...
        // 액션바 설정
        toolbar = (Toolbar) findViewById(R.id.snack_toolbar);
        ...
        title_text = findViewById(R.id.snack_toolbar_title);
    ...
    public void draw(int day, int month, int year){
        ...
        if(day == 0 && month !=0){ // 월간
            ...
            drawChart(pieEntries, year + "년 " + month + "월 안주류 분석");
            ...
            drawChart(pieEntries, year + "년 안주류 분석");
            ...
            drawChart(pieEntries, year + "년 " + month + "월 " + day +"일 안주류 분석");
