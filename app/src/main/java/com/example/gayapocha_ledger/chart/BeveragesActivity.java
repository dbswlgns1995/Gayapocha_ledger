...
public class BeveragesActivity extends AppCompatActivity {
    ...
    private String TAG = "***BeveragesActivity";
    ...
    private String[] menu_title = {"소주","맥주","생탁"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        chart = findViewById(R.id.beverage_piechart);

        bottom_text = findViewById(R.id.beverage_text);

        date_btn = findViewById(R.id.beverage_dmy_btn);
        date_btn.setValue(0);
        date_btn.setOnValueChangedListener(new ToggleButton.OnValueChangedListener() {
            ...
            public void onValueChanged(int value) {
                switch (value){
                    case 0:
                        DatePickerDialog dialogFragment = new DatePickerDialog(BeveragesActivity.this, dateListener, tyear, tmonth - 1, tday);
                        dialogFragment.show();
                        break;
                    case 1:
                        final Calendar today = Calendar.getInstance();
                        MonthPickerDialog.Builder builder = new MonthPickerDialog.Builder(BeveragesActivity.this, new MonthPickerDialog.OnDateSetListener() {
                            @Override
                        ...
                        break;
                    case 2:
                        MonthPickerDialog.Builder year_builder = new MonthPickerDialog.Builder(BeveragesActivity.this, new MonthPickerDialog.OnDateSetListener() {
                            @Override
                            public void onDateSet(int selectedMonth, int selectedYear) {
                                // year 를 선택했을때
        ...
        mDrawerLayout = (DrawerLayout) findViewById(R.id.beverage_drawer_layout);
        navigationView = findViewById(R.id.beverage_nav_view);
        ...
        // 액션바 설정
        toolbar = (Toolbar) findViewById(R.id.beverage_toolbar);
        ...
        title_text = findViewById(R.id.beverage_toolbar_title);
    ...
    public void draw(int day, int month, int year){
        ...
        if(day == 0 && month !=0){ // 월간
            ...
            drawChart(pieEntries, year + "년 " + month + "월 주류 분석");
            ...
            drawChart(pieEntries, year + "년 주류 분석");
            ...
            drawChart(pieEntries, year + "년 " + month + "월 " + day +"일 주류 분석");
